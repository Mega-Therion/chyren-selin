import type { AcknowledgeOptions, MultiSelectOptions, PrompterValue, SelectCommonOptions, SelectNotice, SelectOption, SingleSelectOptions } from "./prompter.js";
export declare const REGISTRY_SETUP_PROTOCOL_VERSION = 1;
...
export type RegistrySetupChildMessage = {
    type: "ready";
    version: typeof REGISTRY_SETUP_PROTOCOL_VERSION;
} | {
    type: "prompt";
    id: number;
    prompt: RegistrySetupPrompt;
} | {
    type: "close-prompt";
    id: number;
} | {
...
export declare function isRegistrySetupChildMessage(value: unknown): value is RegistrySetupChildMessage;
