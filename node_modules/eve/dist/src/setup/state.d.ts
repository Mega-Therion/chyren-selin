...
export type ResolvedVercelProjectSpec = Extract<ResolvedVercelProject, {
    kind: "new" | "existing";
}>;
/**
 ...
 */
export declare function snapshotSetupState(state: SetupState): SetupState;
