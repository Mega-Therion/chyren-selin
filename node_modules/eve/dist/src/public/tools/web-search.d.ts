...
declare const WEB_SEARCH_TOOL_KIND = "eve:web-search-tool";
 ...
 * ```
 */
export declare function webSearch(input: WebSearchToolInput): WebSearchToolDefinition;
/** Returns whether a value is a provider-managed web search definition. */
export declare function isWebSearchToolDefinition(value: unknown): value is WebSearchToolDefinition;
