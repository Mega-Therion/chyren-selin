 ...
 */
export declare const VERCEL_EVE_AGENT_SUMMARY_KIND: "vercel-eve-agent-summary";
/**
 ...
 */
export declare function normalizeChannelKindForDisplay(adapterKind: string | undefined): VercelEveChannelType;
