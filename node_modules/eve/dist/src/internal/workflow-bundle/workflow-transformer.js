...
`?n+2:e[n]===`
`?n+1:n}function stripJavaScriptExtension(e){return e.replace(/\.(?:[cm]?[jt]sx?)$/,``)}function createStepId(e,n){return BUILTIN_STEP_NAMES.has(n)?n:`step//${e}//${n}`}export{transformWorkflowDirectives};