...
export function tryGetVercelTeamId() {
    let token;
    try {
...
export function extractTeamIdFromOidcToken(token) {
    try {
        ...
        const claims = JSON.parse(atob(padded + '='.repeat(padLen)));
...
export function withTeamId(baseUrl, teamId) {
    if (!teamId)
        return baseUrl;
