 ...
 */
export type ConnectPhotonCredentialsParams = Omit<ConnectTokenParams, 'subject'>;
/**
 ...
 * ```
 */
export declare function connectPhotonCredentials(connector: string, params?: ConnectPhotonCredentialsParams, options?: ConnectOptions): ConnectPhotonCredentialProvider;
